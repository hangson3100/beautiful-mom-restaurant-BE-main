...
exports.addReservation = async (req, res) => {
    try {
        ...
        const reservationId = await addReservationDB(customerId, date, tableId, status, notes, peopleCount, uniqueCode);
...
exports.updateReservation = async (req, res) => {
    try {
        ...
        await updateReservationDB(reservationId, date, tableId, status, notes, peopleCount);
...
exports.cancelReservation = async (req, res) => {
    try {
        const reservationId = req.params.id;
        await cancelReservationDB(reservationId, "CANCELLED");
...
exports.searchReservation = async (req, res) => {
    try {
        ...
        const result = await searchReservationsDB(searchString);
...
exports.getReservations = async (req, res) => {
    try {
        ...
        const result = await getReservationsDB(type, from, to);
