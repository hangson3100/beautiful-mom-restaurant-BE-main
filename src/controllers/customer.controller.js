...
exports.addCustomer = async (req, res) => {
    try {
        ...
        const doCustomerExist = await doCustomerExistDB(phone);
        ...
        await addCustomerDB(phone, name, email, birthDate, gender, isMember);
...
exports.getCustomers = async (req, res) => {
    try {
        ...
        const result = await getCustomersDB(page, perPage, sort, filter);
...
exports.updateCustomer = async (req, res) => {
    try {
        ...
        await updateCustomerDB(phone, name, email, birthDate, gender);
...
exports.getCustomer = async (req, res) => {
    try {
        ...
        const result = await getCustomerDB(phone);
...
exports.searchCustomer = async (req, res) => {
    try {
        ...
        const result = await searchCustomerDB(searchString);
